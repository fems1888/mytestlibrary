    ...
    private void renderSelect(State state) {
        if (state == State.SELECT) {
            ...
            if (day.getDate().equals(today)){
                selectedBackground.setBackgroundResource(R.drawable.today_background);

            }else {
                selectedBackground.setBackgroundResource(R.drawable.selected_background);
            }
    ...
    private void renderToday(CalendarDate date) {
        if (date != null) {
            if (date.equals(today)) {
                dateTv.setText(today.getDay()+"");
                todayBackground.setVisibility(VISIBLE);
                todayBackground.setBackgroundResource(R.drawable.today_background);
            } else {
