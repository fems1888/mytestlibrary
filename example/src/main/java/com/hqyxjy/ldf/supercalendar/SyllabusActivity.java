...
public class SyllabusActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SimpleDateFormat sf2 = new SimpleDateFormat("yyyy-M-d");
        SimpleDateFormat sf3 = new SimpleDateFormat("dd");
        Date d = new Date(System.currentTimeMillis());
        Log.e("ldf","OnCreated"+sf.format(d)+"    "+sf2.format(d)+"    "+sf3.format(d));
...
//                refreshSelectBackground();
                Intent intent = new Intent(SyllabusActivity.this,TestActivity.class);
                startActivity(intent);
//                CalendarDate today = new CalendarDate(2017,12,0);
//
//                calendarAdapter.notifyDataChanged(today);
        ...
        lastMonthBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                monthPager.setCurrentItem(monthPager.getCurrentPosition() - 1);
//                CalendarDate today = new CalendarDate(2017,12,22);
//
//                calendarAdapter.notifyDataChanged(today);

                HashMap<String, String> markData = new HashMap<>();
                markData.put("2018-2-6", "1");
...
//        initMarkData();
    ...
    private void initMarkData() {
        HashMap<String, String> markData = new HashMap<>();
        markData.put("2018-2-2", "1");
        markData.put("2018-2-4", "1");
        markData.put("2018-2-3", "1");
        markData.put("2018-2-28", "1");
        calendarAdapter.setMarkData(markData);
        calendarAdapter.notifyDataChanged();
    }
    ...
    private void refreshClickDate(CalendarDate date) {
        ...
        Toast.makeText(getApplicationContext(),date.getYear()+"   "+date.getMonth()+"   "+date.getDay(),Toast.LENGTH_LONG).show();
    }
    ...
    private void initMonthPager() {
        ...
        monthPager.addOnPageChangeListener(new MonthPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                Toast.makeText(getApplicationContext(),"d111",Toast.LENGTH_LONG).show();
